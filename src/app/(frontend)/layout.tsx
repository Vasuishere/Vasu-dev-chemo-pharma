...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Copper Sulphate Pentahydrate manufacturer for agriculture",
    "Copper Sulphate supplier for electroplating and water treatment",
    "feed grade copper sulphate manufacturer for animal nutrition",
    "Manganese Sulphate Monohydrate manufacturer for fertilizer",
    "Manganese Sulphate supplier for animal feed premix",
    "battery grade manganese sulphate supplier for EMD production",
