...
export const MEA_TRIAZINE_FALLBACK_FAQS: FAQItem[] = [
  {
    ...
    answer:
      "MEA Triazine (Monoethanolamine Triazine) is primarily used as an H2S scavenger to remove toxic and corrosive hydrogen sulfide from natural gas, crude oil, biogas, and wastewater. It is essential for protecting infrastructure from corrosion and ensuring safety in oil & gas drilling and refining.",
  },
  {
    question: "How does MEA Triazine work as an H2S scavenger?",
    answer:
      "MEA Triazine reacts quickly and irreversibly with H2S to form stable, non-corrosive, and non-toxic byproducts like thiadiazine. This process effectively removes H2S from drilling and completion fluids, preventing the formation of corrosive acids and improving safety for personnel.",
  },
  {
    question: "What are the primary applications of MEA Triazine?",
    answer:
      "Primary applications include Natural Gas Processing (meeting pipeline specs), Crude Oil Refining (protecting infrastructure), Wastewater Treatment (odor and corrosion control), and Biogas Purification (enhancing gas quality for energy production).",
  },
  {
    question: "What concentrations of MEA Triazine are available?",
    answer:
      "Vasudev Chemo Pharma offers MEA Triazine in 50%, 60%, and 78% concentrations. The 78% grade is the most common for high-efficiency H2S scavenging in oilfield operations.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Importing MEA Triazine 78% into Kuwait requires compliance with KEPA (Kuwait Environment Public Authority) regulations and KFSD (Kuwait Fire Service Directorate) chemical storage standards. You will need a Certificate of Analysis (CoA), GHS-compliant Safety Data Sheet (SDS/MSDS), packing list, commercial invoice, and Bill of Lading. Vasudev Chemo Pharma provides all export documentation formatted for Kuwait customs clearance at Shuwaikh and Shuaiba ports.",
  },
  {
...
export const MEA_TRIAZINE_PRODUCT_PAGE_FAQS: FAQItem[] = [
  {
    question: "What is MEA Triazine 78% used for?",
    answer:
      "MEA Triazine 78% is primarily used as an H2S scavenger in oil and gas pipelines, gas processing systems, crude oil sweetening programs, wastewater treatment, and selected biogas applications.",
  },
  {
    question: "What is the CAS number for MEA Triazine?",
    answer:
      "The CAS number for MEA Triazine, also known as hexahydro-1,3,5-tris(2-hydroxyethyl)-s-triazine, is 4719-04-4.",
  },
  
  {
    question: "What is the minimum order quantity for MEA Triazine?",
    answer:
      "For export orders, the minimum order quantity is 1 MT. For domestic India orders, the minimum order quantity is 220 kg, which is typically one drum.",
  },
  {
    question: "Do you offer samples and technical documents?",
    answer:
      "Yes. Qualified buyers can request a sample along with the Technical Data Sheet, Safety Data Sheet, and batch Certificate of Analysis.",
  },
  {
    question: "Which countries do you export MEA Triazine to?",
    answer:
      "We supply buyers across the GCC, Southeast Asia, the United States, and other international markets. Country-specific delivery and documentation details are covered on our dedicated supply pages.",
  },
];
