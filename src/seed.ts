...
const productSpecificFaqs: Record<string, { question: string; answer: string }[]> = {
  ...
  "triazine-h2s-scavenger-general": [
    {
      question: "How do I choose between MEA and MMA Triazine?",
      answer: "The choice depends on your application. MEA Triazine is typically more reactive and preferred for gas-phase sweetening in contactor towers. MMA Triazine 40% is a BTX-free alternative often chosen for crude oil applications where solids formation (dithiazine) must be minimized and environmental compliance is a priority.",
    },
    {
      question: "What is a non-regenerable H2S scavenger?",
      answer: "Triazines are non-regenerable, meaning they are chemically consumed as they react with H2S. They are ideal for applications with low to moderate H2S loads where the capital expense of an amine regeneration plant is not justified.",
    },
    {
      question: "Are triazine scavengers corrosive to pipelines?",
      answer: "No, triazine-based scavengers are generally non-corrosive to common oilfield metallurgy. In fact, they help reduce corrosion by removing the highly corrosive H2S gas from the system.",
    },
  ],
  "metal-working-fluids": [
    {
      question: "How much biocide should I add to my Metal Working Fluid (MWF)?",
      answer: "Typical treat rates for triazine-based biocides in MWF range from 0.1% to 0.25% by weight of the total fluid. This is usually sufficient to control bacterial and fungal growth and prevent fluid degradation.",
    },
    {
      question: "Is it compatible with synthetic and semi-synthetic oils?",
      answer: "Yes, our triazine additives are designed to be fully miscible and stable in synthetic, semi-synthetic, and soluble oil formulations.",
    },
    {
      question: "Does it provide H2S protection in machining systems?",
      answer: "Yes, by controlling sulfate-reducing bacteria (SRB), these biocides prevent the microbial production of H2S, eliminating the 'Monday morning' odor and preventing blackening of the fluid.",
    },
  ],
  "biocide-oil-gas": [
    {
      question: "How do biocides prevent corrosion in oilfields?",
      answer: "Biocides kill Sulfate-Reducing Bacteria (SRB) which produce corrosive H2S gas. By eliminating these bacteria, the primary source of microbial-influenced corrosion (MIC) is removed, protecting pipelines and injection systems.",
    },
    {
      question: "Are these biocides water-soluble?",
      answer: "Yes, our oilfield biocides are highly water-soluble, ensuring they effectively penetrate and sanitize water-injection systems, produced water, and hydrostatic test water.",
    },
    {
      question: "Can they be used in tandem with H2S scavengers?",
      answer: "Absolutely. Using biocides alongside H2S scavengers like MEA Triazine 78% provides a comprehensive 'kill and scavenge' approach for total system protection.",
    },
  ],
  "mea-triazine-78-high-concentration": [
    {
      question: "Why choose 78% concentration over lower active blends?",
      answer: "Higher concentration reduces the overall volume of chemical required, which significantly lowers freight costs, storage requirements at the site, and the frequency of chemical deliveries, especially for offshore or remote locations.",
    },
    {
      question: "What is the shelf life for export shipments?",
      answer: "Our MEA Triazine 78% is highly stable and has a guaranteed shelf life of 12 months when stored in sealed containers away from direct sunlight and extreme heat.",
    },
  ],
  "mma-triazine-40-btx-free": [
    {
      question: "What does BTX-Free mean for an H2S scavenger?",
      answer: "BTX-Free means the formulation contains no Benzene, Toluene, or Xylene. This is critical for meeting strict environmental regulations in refineries and wastewater plants where aromatic emissions are restricted.",
    },
    {
      question: "Can MMA Triazine 40% be used in winter conditions?",
      answer: "Yes, the 40% concentration of MMA Triazine has a lower freezing point than many higher-active blends, making it easier to pump and handle in colder climates without the need for heated storage.",
    },
  ],
...
const seedProducts: SeedProduct[] = [
  // ─── INDUSTRIAL CHEMICALS (5) ──────────────────────────────
  {
    ...
    description:
      "MEA Triazine 78% is a high-concentration hydrogen sulphide scavenger formulated for oil and gas applications. It reacts irreversibly with H₂S to form non-hazardous dithiazine by-products, ensuring efficient sweetening of crude oil and natural gas streams. For applications requiring BTEX-free solutions, consider our [MMA Triazine 40%](/product/mma-triazine-40). Manufactured by Vasudev Chemo Pharma at our ISO 9001:2015 certified facility in Gujarat, India, this product is supplied at a guaranteed minimum active content of 78%. It is often used in conjunction with [Oilfield Biocides](/product/biocide-oil-gas) for comprehensive microbial and H2S control.",
  ...
  },
  {
    ...
    isActive: true,
    specs: [
      { key: "Type", value: "MEA or MMA Based" },
      { key: "Concentration", value: "20% to 80% available" },
      { key: "Reaction Speed", value: "Instantaneous" },
      { key: "Solubility", value: "Water Soluble" },
    ],
    applications: [
  ...
  },
  {
    ...
    isActive: true,
    specs: [
      { key: "Application Rate", value: "0.1% to 0.25%" },
      { key: "pH Stability", value: "8.5 – 10.5" },
      { key: "Odor Control", value: "Excellent" },
      { key: "Compatibility", value: "Synthetic & Semi-Synthetic" },
    ],
    applications: [
  ...
  },
  {
    ...
    isActive: true,
    specs: [
      { key: "Target Bacteria", value: "SRB & APB" },
      { key: "Thermal Stability", value: "High" },
      { key: "Kill Rate", value: "Rapid" },
      { key: "Solubility", value: "Water Soluble" },
    ],
    applications: [
  ...
  },
  {
    ...
    subcategory: "Oilfield Chemicals",
    description:
      "For large-scale industrial operators, chemical purity and concentration are the keys to logistical efficiency. Vasudev Chemo Pharma’s High-Concentration MEA Triazine 78% is the preferred choice for international oilfield service companies requiring bulk, export-ready H2S scavenging solutions. This high-active formulation is specifically engineered to maximize H2S removal capacity per liter, significantly reducing the frequency of chemical deliveries to remote well sites and offshore platforms.",
    appearance: "Clear to light yellow liquid",
    molecularWeight: "177.20 g/mol",
    hsCode: "29336990",
    originCountry: "India",
    ...
    isActive: true,
    specs: [
      { key: "Active Matter", value: "≥ 78%" },
      { key: "Specific Gravity", value: "1.10 – 1.15" },
      { key: "Reaction Capacity", value: "Maximum per Liter" },
      { key: "Export Standard", value: "ISO 9001:2015" },
    ],
    applications: [
  ...
  },
  {
    ...
    isActive: true,
    specs: [
      { key: "BTX Content", value: "None Detected" },
      { key: "Freeze Point Resistance", value: "Superior" },
      { key: "Eco-Compliance", value: "ESG Ready" },
      { key: "Solubility", value: "High (No Fouling)" },
    ],
    applications: [
